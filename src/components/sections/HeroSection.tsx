        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-[80vw] sm:w-[65vw] max-w-[360px] bg-white text-[#0C0C0C] z-50 shadow-[-12px_0_40px_rgba(0,0,0,0.35)] flex flex-col justify-between p-6 sm:p-8 md:hidden select-none"
            >
              {/* Top Bar: Title + Close Button */}
              <div className="flex items-center justify-between w-full pt-1">
                <span className="text-[#0C0C0C] font-black text-2xl tracking-wider uppercase">
                  Kasim
                </span>
                <button
                  type="button"
                  ...
                  className="w-10 h-10 rounded-full bg-neutral-100 hover:bg-neutral-200 text-[#0C0C0C] flex items-center justify-center transition-colors cursor-pointer"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>

              {/* Navigation Links with Smooth Staggered Slide In */}
              <div className="flex flex-col gap-6 sm:gap-7 my-auto py-6">
                {navLinks.map((link, idx) => (
                  <motion.a
                    ...
                    className="group flex items-center justify-between text-[#0C0C0C] font-black text-2xl sm:text-3xl uppercase tracking-tight hover:translate-x-2 transition-transform duration-200 cursor-pointer"
                  >
                    <span>{link.name}</span>
              ...
              <div className="border-t border-neutral-200/80 pt-5 pb-2">
                <p className="text-black text-xs uppercase tracking-wider font-semibold mb-3.5">
                  Get in touch
                </p>
                <div className="flex items-center gap-5">
                  {[
                    ...
                    <a
                      ...
                      className="text-black hover:opacity-70 transition-all duration-200 hover:scale-110 active:scale-95 flex items-center justify-center p-0.5 cursor-pointer"
                    >
                      {social.icon}
                    </a>
                  ))}
